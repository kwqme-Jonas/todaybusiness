        ...
        <div class="mt-6">
          ...
          <div class=" mt-6">
            ...
            <form action="" method="POST" action="{{route('contact.store')}}">
              ...
              <div>
                <button class="shadow-lg bg-green-500 hover:bg-teal-700 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded-lg" type="submit">Send</button>
              </div> 
              </form>
            </div>      
        </div>
